class ApiEndpoints {
  ...
  static String conversationMessages(String id) => '$_base/conversations/$id/messages/';
  ...
  static String unmuteConversation(String id) => '$_base/conversations/$id/unmute/';
  static String searchConversationMessages(String id) => '$_base/conversations/$id/search/';
