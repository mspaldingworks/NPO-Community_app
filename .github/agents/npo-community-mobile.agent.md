...
description: "Use when building, testing, or deploying the isolated NPO Community Flutter app on supported Apple devices. Never use for LYG, TransConnect, or TransWell apps."
...
Android deployment is paused until the user explicitly resumes it. Do not access or invoke any LYG, TransConnect, or TransWell release/deploy agent, workspace, signing target, backend, or artifact.
